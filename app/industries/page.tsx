...
export const metadata: Metadata = {
  title: "Industries",
  description:
    "KWC Logistics supports meal kit companies, florists, small businesses, warehouses, manufacturers, retail stores, medical suppliers, furniture stores, seniors and families, e-commerce companies, contractors, and homeowners.",
  ...
  return (
    <>
      <PageHero eyebrow="Industries" title="Delivery and freight support for real customers">
        <p>
          Built for small businesses, families, growing companies, and local operators that need
