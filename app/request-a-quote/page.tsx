...
export const metadata: Metadata = {
  ...
  description:
    "Request a logistics quote from KWC Logistics for final mile delivery, B2B delivery, LTL freight, warehouse transfers, hot shot delivery, or regional distribution in Ontario.",
  ...
  return (
    <>
      <PageHero eyebrow="Request a Quote" title="Send the shipment details">
        <p>
          Include pickup and delivery cities, freight details, timing, and any liftgate or handling
          needs. For urgent jobs, call dispatch at <a className="font-semibold text-brand-blue" href={`tel:${site.phone}`}>{site.phone}</a>.
        </p>
      </PageHero>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_0.45fr] lg:px-8">
          ...
          <aside className="rounded-md bg-brand-pale p-6">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-6 text-muted">
              ...
              <li>Whether pickup or delivery needs a liftgate.</li>
