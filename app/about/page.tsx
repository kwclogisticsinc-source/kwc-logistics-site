...
export const metadata: Metadata = {
  title: "About",
  description:
    "KWC Logistics Inc. is a Canadian logistics company based in Kitchener, Ontario serving businesses, homeowners, seniors, and everyday customers.",
...
export default function AboutPage() {
  return (
    <>
      <PageHero eyebrow="About KWC" title="A Canadian logistics company based in Kitchener">
        <p>
          KWC Logistics Inc. is built around direct communication, dependable delivery work,
          and real accountability for businesses, homeowners, seniors, and everyday customers.
        </p>
      </PageHero>
